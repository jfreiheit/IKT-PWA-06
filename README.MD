...
Der aktuelle Stand ist der Zustand des Frontends bevor wir uns mit Geolocation beschäftigen. Das zugehörige Backend kann [hier](https://github.com/jfreiheit/IKT-PWA-BACKEND-01) geklont werden.
...
siehe `git checkout --track origin/nach_geolocation` 
